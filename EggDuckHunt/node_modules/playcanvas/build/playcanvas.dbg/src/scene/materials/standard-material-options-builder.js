...
class StandardMaterialOptionsBuilder {
    ...
    _updateUVOptions(options, stdMat, objDefs, minimalOptions, cameraShaderParams) {
        ...
        options.litOptions.ssao = cameraShaderParams == null ? undefined : cameraShaderParams.ssaoEnabled;
    ...
    _updateMaterialOptions(options, stdMat) {
        ...
        options.glossTint = 1;
        options.diffuseEncoding = (_stdMat_diffuseMap = stdMat.diffuseMap) == null ? undefined : _stdMat_diffuseMap.encoding;
        options.diffuseDetailEncoding = (_stdMat_diffuseDetailMap = stdMat.diffuseDetailMap) == null ? undefined : _stdMat_diffuseDetailMap.encoding;
        options.emissiveEncoding = (_stdMat_emissiveMap = stdMat.emissiveMap) == null ? undefined : _stdMat_emissiveMap.encoding;
        options.lightMapEncoding = (_stdMat_lightMap = stdMat.lightMap) == null ? undefined : _stdMat_lightMap.encoding;
