 ...
 */ class GraphNode extends EventHandler {
     ...
     */ set enabled(enabled) {
        if (this._enabled !== enabled) {
            ...
            if (enabled && ((_this__parent = this._parent) == null ? undefined : _this__parent.enabled) || !enabled) {
     ...
     */ remove() {
        var _this__parent;
        (_this__parent = this._parent) == null ? undefined : _this__parent.removeChild(this);
    }
    /**
     ...
     */ _prepareInsertChild(node) {
        ...
        node.remove();
        Debug.assert(node !== this, "GraphNode " + (node == null ? undefined : node.name) + " cannot be a child of itself");
        Debug.assert(!this.isDescendantOf(node), "GraphNode " + (node == null ? undefined : node.name) + " cannot add an ancestor as a child");
    }
    /**
