...
class ViewCube extends EventHandler {
     ...
     */ _line(color) {
        var result = /** @type {SVGLineElement} */ document.createElementNS(this._svg.namespaceURI, 'line');
     ...
     */ _circle(color, fill, text) {
        ...
        var group = /** @type {SVGAElement} */ document.createElementNS(this._svg.namespaceURI, 'g');
        var circle = /** @type {SVGCircleElement} */ document.createElementNS(this._svg.namespaceURI, 'circle');
        ...
        if (text) {
            var t = /** @type {SVGTextElement} */ document.createElementNS(this._svg.namespaceURI, 'text');
