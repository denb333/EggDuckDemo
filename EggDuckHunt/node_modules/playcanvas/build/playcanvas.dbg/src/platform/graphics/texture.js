 ...
 */ class Texture {
        ...
        if (value !== currentSrgb) {
            if (value) {
                ...
                if (this._format !== srgbFormat) {
                    var _pixelFormatInfo_get, _pixelFormatInfo_get1;
                    Debug.warn("Switching format of texture '" + this.name + "' to sRGB equivalent: " + ((_pixelFormatInfo_get = pixelFormatInfo.get(this.format)) == null ? undefined : _pixelFormatInfo_get.name) + " -> " + ((_pixelFormatInfo_get1 = pixelFormatInfo.get(srgbFormat)) == null ? undefined : _pixelFormatInfo_get1.name) + ". This is an expensive operation, and the texture should be created using the right format to avoid this.", this);
                ...
                if (this._format !== linearFormat) {
                    var _pixelFormatInfo_get2, _pixelFormatInfo_get3;
                    Debug.warn("Switching format of texture '" + this.name + "' to linear equivalent: " + ((_pixelFormatInfo_get2 = pixelFormatInfo.get(this.format)) == null ? undefined : _pixelFormatInfo_get2.name) + " -> " + ((_pixelFormatInfo_get3 = pixelFormatInfo.get(linearFormat)) == null ? undefined : _pixelFormatInfo_get3.name) + ". This is an expensive operation, and the texture should be created using the right format to avoid this.", this);
     ...
     */ this.renderVersionDirty = 0;
        ...
        Debug.trace(TRACEID_TEXTURE_ALLOC, "Alloc: Id " + this.id + " " + this.name + ": " + this.width + "x" + this.height + " [" + ((_pixelFormatInfo_get = pixelFormatInfo.get(this.format)) == null ? undefined : _pixelFormatInfo_get.name) + "]" + ("" + (this.cubemap ? '[Cubemap]' : '')) + ("" + (this.volume ? '[Volume]' : '')) + ("" + (this.array ? '[Array]' : '')) + ("[MipLevels:" + this.numLevels + "]"), this);
    }
}
