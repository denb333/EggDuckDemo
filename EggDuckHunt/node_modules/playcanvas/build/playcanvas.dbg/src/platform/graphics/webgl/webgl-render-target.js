 ...
 */ class WebglRenderTarget {
    ...
    _createMsaaMrtFramebuffers(device, target, colorBufferCount) {
        var _this, _loop = function(i) {
            ...
            var buffer = _this._glMsaaColorBuffers[i];
            gl.bindRenderbuffer(gl.RENDERBUFFER, buffer);
            ...
            Debug.call(()=>_this._checkFbo(device, target, "MSAA-MRT-src" + i));
            // dst
            ...
            _this.colorMrtFramebuffers[i] = new FramebufferPair(srcFramebuffer, dstFramebuffer);
            Debug.call(()=>_this._checkFbo(device, target, "MSAA-MRT-dst" + i));
        };
        var gl = device.gl;
        this.colorMrtFramebuffers = [];
        for(var i = 0; i < colorBufferCount; ++i)_this = this, _loop(i);
    }
    /**
