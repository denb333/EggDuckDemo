 ...
 */ class BindGroup {
     ...
     */ update() {
        ...
        for(var i1 = 0; i1 < storageTextureFormats.length; i1++){
            ...
            Debug.assert(value1, "Value was not set when assigning storage texture slot [" + storageTextureFormat.name + "] to a bind group, while rendering [" + DebugGraphics.toString() + "]", this);
        ...
        for(var i2 = 0; i2 < storageBufferFormats.length; i2++){
            ...
            Debug.assert(value2, "Value was not set when assigning storage buffer slot [" + storageBufferFormat.name + "] to a bind group, while rendering [" + DebugGraphics.toString() + "]", this);
