 ...
 */ class WebglGraphicsDevice extends GraphicsDevice {
            ...
            for(var i1 = 0; i1 < colorBufferCount; i1++){
                ...
                if (colorOps1.genMipmaps) {
                    ...
                    if (colorBuffer && colorBuffer.impl._glTexture && colorBuffer.mipmaps) {
                        DebugGraphics.pushGpuMarker(this, "MIPS" + i1);
    ...
    debugLoseContext(sleep) {
        if (sleep === undefined) sleep = 100;
     ...
     */ this._defaultFramebufferChanged = false;
        ...
        /** @type {WebGL2RenderingContext} */ var gl = (_options_gl = options.gl) != null ? _options_gl : canvas.getContext('webgl2', options);
        if (!gl) {
