 ...
 */ class WebgpuRenderTarget {
    ...
    initDepthStencil(device, wgpu, renderTarget) {
        ...
        if (depth || depthBuffer) {
            ...
            if (!depthBuffer) {
                ...
                /** @type {GPUTextureDescriptor} */ var depthTextureDesc = {
                    size: [
                        width,
                        height,
                        1
                ...
                if (samples > 1) {
                    ...
                    var msDepthTexture = msTextures.get(key); // this incRefs it if found
                    if (!msDepthTexture) {
                        /** @type {GPUTextureDescriptor} */ var multisampledDepthDesc = {
                            size: [
                                width,
                                height,
                                1
     ...
     */ initColor(device, wgpu, renderTarget, index) {
        ...
        /** @type {GPURenderPassColorAttachment} */ var colorAttachment = {};
        ...
        if (samples > 1) {
            ...
            /** @type {GPUTextureDescriptor} */ var multisampledTextureDesc = {
                size: [
                    width,
                    height,
                    1
