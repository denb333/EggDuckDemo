...
var LINE_BREAK_CHAR = /^[\r\n]$/;
var WHITESPACE_CHAR = /^[ \t]$/;
var WORD_BOUNDARY_CHAR = /^[ \t\-]|\u200b$/; // NB \u200b is zero width space
...
class TextElement {
    ...
    _updateMeshes() {
        ...
        for(var i2 = 0; i2 < this._meshInfo.length; i2++){
            ...
            var numVertices = this._meshInfo[i2].count * 4; // number of verts we allocated
            var vertMax = this._meshInfo[i2].quad * 4; // number of verts we need (usually count minus line break characters)
