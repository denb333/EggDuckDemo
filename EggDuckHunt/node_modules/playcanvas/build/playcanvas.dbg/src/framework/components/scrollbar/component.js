 ...
 */ class ScrollbarComponent extends Component {
    ...
    _handleEntityUnsubscribe() {
        ...
        (_this__evtHandleEntityElementAdd = this._evtHandleEntityElementAdd) == null ? undefined : _this__evtHandleEntityElementAdd.off();
        this._evtHandleEntityElementAdd = null;
        if ((_this__handleEntity = this._handleEntity) == null ? undefined : _this__handleEntity.element) {
    ...
    _onSetOrientation(name, oldValue, newValue) {
        ...
        if (newValue !== oldValue && ((_this__handleEntity = this._handleEntity) == null ? undefined : _this__handleEntity.element)) {
            this._handleEntity.element[this._getOppositeDimension()] = 0;
        }
    }
    _updateHandlePositionAndSize() {
        var handleEntity = this._handleEntity;
        var handleElement = handleEntity == null ? undefined : handleEntity.element;
        if (handleEntity) {
