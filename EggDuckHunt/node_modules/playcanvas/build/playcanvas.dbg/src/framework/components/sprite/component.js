 ...
 */ class SpriteComponent extends Component {
     ...
     */ set batchGroupId(value) {
        ...
        if (this.entity.enabled && prev >= 0) {
            ...
            (_this_system_app_batcher = this.system.app.batcher) == null ? undefined : _this_system_app_batcher.remove(BatchGroup.SPRITE, prev, this.entity);
        }
        if (this.entity.enabled && value >= 0) {
            var _this_system_app_batcher1;
            (_this_system_app_batcher1 = this.system.app.batcher) == null ? undefined : _this_system_app_batcher1.insert(BatchGroup.SPRITE, value, this.entity);
        } else {
    ...
    onEnable() {
        ...
        if (this._batchGroupId >= 0) {
            var _app_batcher;
            (_app_batcher = app.batcher) == null ? undefined : _app_batcher.insert(BatchGroup.SPRITE, this._batchGroupId, this.entity);
        }
    }
    onDisable() {
        ...
        if (this._batchGroupId >= 0) {
            var _app_batcher;
            (_app_batcher = app.batcher) == null ? undefined : _app_batcher.remove(BatchGroup.SPRITE, this._batchGroupId, this.entity);
        }
    }
    onDestroy() {
        var _this__node;
        ...
        this._hideModel();
        this._model = null;
        (_this__node = this._node) == null ? undefined : _this__node.remove();
        this._node = null;
        if (this._meshInstance) {
