 ...
 */ class XrAnchors extends EventHandler {
     ...
     */ update(frame) {
        ...
        for (var xrAnchor1 of frame.trackedAnchors){
            ...
            try {
                var tmp = xrAnchor1.anchorSpace; // eslint-disable-line no-unused-vars
            } catch (ex) {
                continue;
            }
     ...
     * @type {boolean}
     * @private
     */ this._persistence = platform.browser && !!((_window = window) == null ? undefined : (_window_XRSession = _window.XRSession) == null ? undefined : _window_XRSession.prototype.restorePersistentAnchor), /**
