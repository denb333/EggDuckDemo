 ...
 */ class XrHitTest extends EventHandler {
     ...
     */ start(options) {
        ...
        if (!this._supported) {
            options.callback == null ? undefined : options.callback.call(options, new Error('XR HitTest is not supported'), null);
            return;
        }
        if (!this._available) {
            options.callback == null ? undefined : options.callback.call(options, new Error('XR HitTest is not available'), null);
            return;
        }
