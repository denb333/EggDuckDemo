...
import { PIXELFORMAT_DEPTH, PIXELFORMAT_R32F, PIXELFORMAT_RGB8, ADDRESS_CLAMP_TO_EDGE, FILTER_LINEAR, FILTER_NEAREST } from '../../platform/graphics/constants.js';
...
class XrView extends EventHandler {
		...
		get depthValueToMeters() {
				...
				return ((_this__depthInfo = this._depthInfo) == null ? undefined : _this__depthInfo.rawValueToMeters) || 0;
		}
		get eye() {
		...
		_updateDepth(frame) {
				...
				var width = ((_this__depthInfo = this._depthInfo) == null ? undefined : _this__depthInfo.width) || 4;
				var height = ((_this__depthInfo1 = this._depthInfo) == null ? undefined : _this__depthInfo1.height) || 4;
				var resized = false;
		...
		getDepth(u, v) {
				...
				return (_this__depthInfo_getDepthInMeters = (_this__depthInfo = this._depthInfo) == null ? undefined : _this__depthInfo.getDepthInMeters(u, v)) != null ? _this__depthInfo_getDepthInMeters : null;
		}
		destroy() {
				this._depthInfo = null;
