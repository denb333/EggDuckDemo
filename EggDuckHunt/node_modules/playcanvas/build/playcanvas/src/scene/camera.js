...
import { PROJECTION_PERSPECTIVE, ASPECT_AUTO, LAYERID_WORLD, LAYERID_DEPTH, LAYERID_SKYBOX, LAYERID_UI, LAYERID_IMMEDIATE } from './constants.js';
...
class Camera {
		destroy() {
				...
				(_this_renderPassColorGrab = this.renderPassColorGrab) == null ? undefined : _this_renderPassColorGrab.destroy();
				this.renderPassColorGrab = null;
				(_this_renderPassDepthGrab = this.renderPassDepthGrab) == null ? undefined : _this_renderPassDepthGrab.destroy();
		...
		get aspectRatio() {
				var _this_xr;
				return ((_this_xr = this.xr) == null ? undefined : _this_xr.active) ? this._xrProperties.aspectRatio : this._aspectRatio;
		}
		...
		get farClip() {
				var _this_xr;
				return ((_this_xr = this.xr) == null ? undefined : _this_xr.active) ? this._xrProperties.farClip : this._farClip;
		}
		...
		get fov() {
				var _this_xr;
				return ((_this_xr = this.xr) == null ? undefined : _this_xr.active) ? this._xrProperties.fov : this._fov;
		}
		...
		get horizontalFov() {
				var _this_xr;
				return ((_this_xr = this.xr) == null ? undefined : _this_xr.active) ? this._xrProperties.horizontalFov : this._horizontalFov;
		}
		set layers(newValue) {
		...
		get nearClip() {
				var _this_xr;
				return ((_this_xr = this.xr) == null ? undefined : _this_xr.active) ? this._xrProperties.nearClip : this._nearClip;
		}
		set node(newValue) {
				this._node = newValue;
		}
		...
		worldToScreen(worldCoord, cw, ch, screenCoord) {
				if (screenCoord === undefined) screenCoord = new Vec3();
		...
		screenToWorld(x, y, z, cw, ch, worldCoord) {
				if (worldCoord === undefined) worldCoord = new Vec3();
		...
		getFrustumCorners(near, far) {
				if (near === undefined) near = this.nearClip;
				if (far === undefined) far = this.farClip;
