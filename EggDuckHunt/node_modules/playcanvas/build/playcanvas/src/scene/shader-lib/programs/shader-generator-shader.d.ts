...
declare class ShaderGeneratorShader extends ShaderGenerator {
    ...
    createVertexDefinition(definitionOptions: any, options: any, sharedIncludes: any): void;
    createFragmentDefinition(definitionOptions: any, options: any, sharedIncludes: any): void;
